            iceberg_slice.placed_at = datetime.now()
    ...
    def on_slice_fill(self,
        ...
        total_value = iceberg.avg_fill_price * (iceberg.total_filled - filled_qty)
        total_value += fill_price * filled_qty
        iceberg.avg_fill_price = total_value / iceberg.total_filled

        # Calculate price improvement
        if iceberg.transaction_type == "BUY":
            improvement = iceberg.price - fill_price
        else:
            improvement = fill_price - iceberg.price

        iceberg.total_price_improvement += improvement * filled_qty
